    ...
    <section className="py-32 px-6 lg:px-12 bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 relative z-10">
        <div>
          ...
          <div className="mt-12 rounded-[2rem] overflow-hidden border border-slate-100 shadow-sm h-64 relative">
             <iframe 
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1m3!1d3781.656514781744!2d73.7464016148937!3d18.599616087363!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2b9a7167d3e0b%3A0x6b4458f2be4c5e3!2sVision%20One%20Mall!5e0!3m2!1sen!2sin!4v1689254128522!5m2!1sen!2sin" 
               width="100%" 
               height="100%" 
               style={{ border: 0 }} 
               ...
               title="KS Design Studio Pune Location"
             />
          </div>
        </div>
